...
if __name__ == "__main__":
    ...
    parser.add_argument('-m','--model',action='store',type=str,nargs='+',dest='model')
    parser.add_argument('-f','--file',action='store',type=str,dest='file')
    parser.add_argument('-t','--timespan',action='store',type=int,dest='timespan',default=DEFAULT_TIMESPAN)
    parser.add_argument('-a','--all',action='store_true',dest='all',default=False)
    parser.add_argument('-x','--action',action='store',type=str,dest='action')
    parser.add_argument('-d','--searchdomain',action='store',type=str,nargs=3,dest='searchdomain')
